...
const isUUIDMatch = (inputString) => {
  const regex =
    /(c|cpp|csharp|dart|go|htmlcssjs|java|javascript|kotlin|mongodb|perl|python|ruby|rust|sql|typescript|verilog)-([a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/;
